...
if __name__ == '__main__':
    model = YOLO("D:/pythonProject/ultralytics-main2/ultralytics/cfg/models/UAV/finally5.yaml")
    # results = model.train(data="D:/pythonProject/ultralytics-main2/ultralytics/datasets/Drone677/data.yaml", model="D:/pythonProject/ultralytics-main2/ultralytics/cfg/models/UAV/finally5.yaml", imgsz=640, batch=4, workers=2)
